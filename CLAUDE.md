...
> Tomadas depois de ler `reports/round1-report.md` e antes do gabarito, sem ler o código dos
> projetos. Lista congelada em `docs/round2-changes.md` antes de qualquer edição. ADRs completos
